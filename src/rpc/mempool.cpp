...
static RPCHelpMan gettxspendingprevout()
{
    return RPCHelpMan{"gettxspendingprevout",
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            const bool mempool_only{options.exists("mempool_only") ? options["mempool_only"].get_bool() : false};
            ...
            const bool txospenderindex_ready = !mempool_only && g_txospenderindex && g_txospenderindex->BlockUntilSyncedToCurrentChain();
